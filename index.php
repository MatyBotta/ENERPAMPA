...
<body>
    ...
    <div id="carouselExampleIndicators" class="carousel slide vh-100 overflow-hidden" data-bs-ride="true">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="imagenes/inicio/prueba-01.jpg" class="d-block w-100" alt="...">
          </div>
    ...
    <div class="card">
        ...
        <div class="contenido-card">
            ...
            <p>Estar atento a la necesidad especifica del cliente. Asesorandolo constantemente en las variables tecnicas que surgan.Acompañando con nuestro conocimiento profesional para la realizacion del proyecto. </p>
